...
public class YaLangYieldStmtImpl extends ASTWrapperPsiElement implements YaLangYieldStmt {

  public YaLangYieldStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YaLangYieldExpr getYieldExpr() {
    return findNotNullChildByClass(YaLangYieldExpr.class);
  }
