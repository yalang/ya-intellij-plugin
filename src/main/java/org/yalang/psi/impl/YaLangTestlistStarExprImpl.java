...
public class YaLangTestlistStarExprImpl extends ASTWrapperPsiElement implements YaLangTestlistStarExpr {

  public YaLangTestlistStarExprImpl(@NotNull ASTNode node) {
    super(node);
  }
