...
public class YaLangSubscriptImpl extends ASTWrapperPsiElement implements YaLangSubscript {

  public YaLangSubscriptImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public YaLangSliceop getSliceop() {
    return findChildByClass(YaLangSliceop.class);
  }
