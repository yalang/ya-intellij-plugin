...
public class YaLangDelStmtImpl extends ASTWrapperPsiElement implements YaLangDelStmt {

  public YaLangDelStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YaLangVisitor visitor) {
    visitor.visitDelStmt(this);
  }
