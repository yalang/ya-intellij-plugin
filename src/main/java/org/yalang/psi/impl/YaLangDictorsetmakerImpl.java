...
public class YaLangDictorsetmakerImpl extends ASTWrapperPsiElement implements YaLangDictorsetmaker {

  public YaLangDictorsetmakerImpl(@NotNull ASTNode node) {
    super(node);
  }
