...
public class YaLangStarExprImpl extends ASTWrapperPsiElement implements YaLangStarExpr {

  public YaLangStarExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YaLangExpr getExpr() {
    return findNotNullChildByClass(YaLangExpr.class);
  }
