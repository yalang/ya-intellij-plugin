...
public class YaLangSliceopImpl extends ASTWrapperPsiElement implements YaLangSliceop {

  public YaLangSliceopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YaLangVisitor visitor) {
    visitor.visitSliceop(this);
  }
