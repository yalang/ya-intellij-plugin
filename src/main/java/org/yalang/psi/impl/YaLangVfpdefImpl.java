...
public class YaLangVfpdefImpl extends ASTWrapperPsiElement implements YaLangVfpdef {

  public YaLangVfpdefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YaLangVisitor visitor) {
    visitor.visitVfpdef(this);
  }
