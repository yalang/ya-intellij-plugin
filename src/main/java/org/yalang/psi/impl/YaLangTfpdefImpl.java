...
public class YaLangTfpdefImpl extends ASTWrapperPsiElement implements YaLangTfpdef {

  public YaLangTfpdefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YaLangVisitor visitor) {
    visitor.visitTfpdef(this);
  }
