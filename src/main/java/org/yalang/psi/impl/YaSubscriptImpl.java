...
public class YaSubscriptImpl extends ASTWrapperPsiElement implements YaSubscript {

  public YaSubscriptImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public YaSliceop getSliceop() {
    return findChildByClass(YaSliceop.class);
  }
