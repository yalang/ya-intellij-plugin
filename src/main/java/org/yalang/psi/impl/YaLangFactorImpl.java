...
public class YaLangFactorImpl extends ASTWrapperPsiElement implements YaLangFactor {

  public YaLangFactorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public YaLangPower getPower() {
    return findChildByClass(YaLangPower.class);
  }
