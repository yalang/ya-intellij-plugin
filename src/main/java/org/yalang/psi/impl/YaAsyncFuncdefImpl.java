...
public class YaAsyncFuncdefImpl extends ASTWrapperPsiElement implements YaAsyncFuncdef {

  public YaAsyncFuncdefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YaFuncdef getFuncdef() {
    return findNotNullChildByClass(YaFuncdef.class);
  }
