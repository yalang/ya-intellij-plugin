...
public abstract class YaLangStringLiteralLexerBase extends LexerBase {
  protected static final Logger LOG = Logger.getInstance("#org.yalang.lexer.PyStringLiteralLexer");
  ...
  public YaLangStringLiteralLexerBase(final IElementType originalLiteralToken) {
