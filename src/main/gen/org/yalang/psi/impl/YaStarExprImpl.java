...
public class YaStarExprImpl extends ASTWrapperPsiElement implements YaStarExpr {

  public YaStarExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YaExpr getExpr() {
    return findNotNullChildByClass(YaExpr.class);
  }
