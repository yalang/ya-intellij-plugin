...
public class YaYieldStmtImpl extends ASTWrapperPsiElement implements YaYieldStmt {

  public YaYieldStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YaYieldExpr getYieldExpr() {
    return findNotNullChildByClass(YaYieldExpr.class);
  }
