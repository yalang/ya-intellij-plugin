...
public class YaComparisonImpl extends ASTWrapperPsiElement implements YaComparison {

  public YaComparisonImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<YaCompOp> getCompOpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YaCompOp.class);
  }
